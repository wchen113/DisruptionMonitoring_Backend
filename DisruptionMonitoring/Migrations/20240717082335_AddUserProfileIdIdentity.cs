...
{
    /// <inheritdoc />
    public partial class AddUserProfileIdIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City_Ascii = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BP_Code = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BP_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Address_3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_4 = table.Column<string>(type: "nvarchar(max)", nullable: true),
